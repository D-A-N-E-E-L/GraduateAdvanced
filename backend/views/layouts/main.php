...
<header>
    ...
    $menuItems = [
        ...
        ['label' => 'Данные', 'url' => ['/site/tables']],
    ];
    if (Yii::$app->user->isGuest) {
        $menuItems[] = ['label' => 'Вход в аккаунт', 'url' => ['/site/login']];
    }
    echo Nav::widget([
...
<script>
  ...
  secret.addEventListener('click', function(e) {
    if (g){
      body.setAttribute('style','background: url("img/f.gif"); background-size: 100% 100%; animation: gradient 0s')
      g = false
      audio.play()
    }else {
